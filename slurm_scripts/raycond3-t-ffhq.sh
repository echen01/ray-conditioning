...
python /share/phoenix/nfs04/S7/emc348/ray-conditioning/train.py --outdir=/share/phoenix/nfs04/S7/emc348/stylegan3/training-runs --data=/path/to/ffhq --cfg=raycond3-t --fgpus=2 --batch=32 --gamma=10 --snap=20 --cond=1 --aug=noaug --resume=/share/phoenix/nfs04/S7/emc348/nerf/eg3d/stylegan3-t-ffhq-1024x1024.pkl
