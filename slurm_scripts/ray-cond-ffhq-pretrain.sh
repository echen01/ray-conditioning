...
#SBATCH -J FFHQHom                          # Job name
#SBATCH -o FFHQHom.o                              # Name of stdout output file (%j expands to jobId)
#SBATCH -e FFHQHom.o                              # Name of stderr output file (%j expands to jobId)
