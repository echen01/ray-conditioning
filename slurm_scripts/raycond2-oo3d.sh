...
#SBATCH -o OO3D.o                              # Name of stdout output file (%j expands to jobId)
#SBATCH -e OO3D.o                              # Name of stderr output file (%j expands to jobId)
...
python /share/phoenix/nfs04/S7/emc348/ray-conditioning/train.py --outdir=/share/phoenix/nfs04/S7/emc348/stylegan3/training-runs --data=/share/davis/emc348/oo3d/OO3D.zip --cfg=raycond2 --gpus=2 --batch=32 --gamma=0.3 --snap=20 --cond=1 --aug=noaug 
