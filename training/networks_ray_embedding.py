        ...
        **layer_kwargs,
        ...
        if self.in_channels == 0:
            ...
            if self.ray_cond:
                ...
                x = torch.cat([x, rays_next], dim=1)

        else:
            if self.ray_cond:
                with torch.no_grad():
                    rays_in = self.embedding(
                        self.resolution // 2,
                        self.resolution // 2,
                        intrinsics,
                        c2ws,
        ...
        **block_kwargs,  # Arguments for SynthesisBlock.
        ...
        for res in self.block_resolutions:
            """if res >= 128:
                ...
                in_channels = 0"""
            in_channels = channels_dict[res // 2] + 6 if res > 4 else 0
