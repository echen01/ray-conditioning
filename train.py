...
def main(**kwargs):
    ...
    if opts.cfg == "stylegan2":
        ...
        if opts.cfg == "stylegan3-r" or opts.cfg == "raycond3-r":
            ...
            c.G_kwargs.use_radial_filters = (
                True  # Use radially symmetric downsampling filters.
            )
            c.loss_kwargs.blur_init_sigma = (
                10  # Blur the images seen by the discriminator.
            )
            c.loss_kwargs.blur_fade_kimg = (
                c.batch_size * 200 / 32
