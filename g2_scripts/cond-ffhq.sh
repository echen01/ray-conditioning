...
#SBATCH -J FFHQCond                           # Job name
#SBATCH -o FFHQCond.o                              # Name of stdout output file (%j expands to jobId)
#SBATCH -e FFHQCond.o                              # Name of stderr output file (%j expands to jobId)
...
python /share/phoenix/nfs04/S7/emc348/stylegan3/train.py --outdir=/share/phoenix/nfs04/S7/emc348/stylegan3/training-runs --data=/share/cuvl/emc348/FFHQ_png_512.zip --cfg=stylegan2 --gpus=2 --batch=32 --gamma=1 --snap=20 --metrics=none --cond=1 --aug=noaug --resume=/share/cuvl/emc348/pretrained_models/stylegan2-ffhq-512x512.pkl
