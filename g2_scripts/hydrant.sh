...
#SBATCH -J Hydrant                          # Job name
#SBATCH -o Hydrant.o                              # Name of stdout output file (%j expands to jobId)
#SBATCH -e Hydrant.o                              # Name of stderr output file (%j expands to jobId)
...
python /share/phoenix/nfs04/S7/emc348/stylegan3/train.py --outdir=/share/phoenix/nfs04/S7/emc348/stylegan3/training-runs --data=/share/cuvl/emc348/datasets/hydrant.zip --cfg=ray-cond --gpus=4 --batch=32 --gamma=1 --snap=20 --metrics=none --cond=1 --aug=noaug 
