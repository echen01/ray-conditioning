...
#SBATCH -J ShapeNetCars                           # Job name
#SBATCH -o ShapeNetCars.o                              # Name of stdout output file (%j expands to jobId)
#SBATCH -e ShapeNetCars.o                              # Name of stderr output file (%j expands to jobId)
...
#SBATCH --gres=gpu:2080ti:4                         # gpu:gpu_type:how_many_gpu
...
python /share/phoenix/nfs04/S7/emc348/stylegan3/train.py --outdir=/share/phoenix/nfs04/S7/emc348/stylegan3/training-runs --data=/share/phoenix/nfs04/S7/emc348/nerf/eg3d/cars_train.zip --cfg=cam-field --gpus=4 --batch=32 --gamma=0.3 --snap=20 --metrics=none --cond=0 --aug=noaug
