...
python /share/phoenix/nfs04/S7/emc348/stylegan3/train.py --outdir=/share/phoenix/nfs04/S7/emc348/stylegan3/training-runs --data=/share/phoenix/nfs04/S7/emc348/nerf/eg3d/processed_afhq.zip --cfg=ray-cond-3 --gpus=4 --batch=32 --gamma=5 --snap=20 --metrics=none --cond=1 --aug=noaug  --resume=/share/cuvl/emc348/pretrained_models/stylegan3-t-afhqv2-512x512.pkl
