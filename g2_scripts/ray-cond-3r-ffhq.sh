...
#SBATCH -J FFHQ3R                           # Job name
#SBATCH -o FFHQ3R.o                              # Name of stdout output file (%j expands to jobId)
#SBATCH -e FFHQ3R.o                              # Name of stderr output file (%j expands to jobId)
...
python /share/phoenix/nfs04/S7/emc348/stylegan3/train.py --outdir=/share/phoenix/nfs04/S7/emc348/stylegan3/training-runs --data=/share/cuvl/sh844/FFHQ_1024.zip --cfg=ray-cond-3r --gpus=2 --batch=32 --batch-gpu=8 --gamma=10 --snap=20 --metrics=none --cond=1 --aug=noaug --resume=/share/phoenix/nfs04/S7/emc348/nerf/eg3d/stylegan3-r-ffhq-1024x1024.pkl
