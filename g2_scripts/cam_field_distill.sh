...
#SBATCH -J ShapeNetCarsPE                           # Job name
#SBATCH -o ShapeNetCarsDistill.o                              # Name of stdout output file (%j expands to jobId)
#SBATCH -e ShapeNetCarsDistill.o                              # Name of stderr output file (%j expands to jobId)
...
python /share/phoenix/nfs04/S7/emc348/stylegan3/train.py --outdir=/share/phoenix/nfs04/S7/emc348/stylegan3/training-runs --data=/scratch/datasets/cars_full_params.zip --cfg=cam-field-distillation --gpus=2 --batch=32 --gamma=0.3 --snap=20 --metrics=none --cond=1 --aug=noaug
